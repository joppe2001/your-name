					...
					<div class="comments__view">
						<div class="w-100 flex">
							...
							<div class="wrapper">
								<a
									href="#"
									@click.prevent="post.showComments = !post.showComments"
									class="comments__submit p-2"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
						...
						<transition name="modal">
							<div
								class="modal-mask fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center"
								v-show="post.showComments"
								@click.self="post.showComments = false"
							>
								<div class="modal-wrapper">
									<!-- Modal container -->
									<div
										class="modal-container bg-white rounded shadow-lg px-10 py-6 relative"
										@click.stop
									>
										<!-- Modal close -->
										<div
											class="modal-close absolute top-0.5 right-1 cursor-pointer"
