<template>
	<div class="flex items-center justify-center p-4">
		<div class="max-w-4xl mx-auto">
			<h1
				class="text-yn-sunset font-extrabold text-2xl sm:text-4xl lg:text-5xl mb-4 sm:mb-6 text-center"
			>
				...
				>
					<div>
						...
						<p class="text-black text-sm sm:text-lg mb-4 sm:mb-8">
							...
							She's tired of her everyday life and wishes for something more
							exciting to happen.
						</p>
					</div>
					<nuxt-link
				...
				>
					<div>
						...
						<p class="text-black text-sm sm:text-lg mb-4 sm:mb-8">
							...
							part-time job at an Italian restaurant and dreams of becoming an
